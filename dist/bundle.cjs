...
var require_search = __commonJS({
  "src/search.js"(exports2, module2) {
    var { Command: Command2 } = require_commander();
    var https = require("https");
    var { URL: NodeURL } = require("url");
    var URL = "https://8rn1y79f02-dsn.algolia.net/1/indexes/*/queries";
    var HEADERS = {
    ...
    var searchCmd = new Command2("search").description("\u641C\u7D22\u8CA8\u7269").argument("<query>").option("-p, --page <page>", "\u6307\u5B9A\u9801\u9762 (1-N)", "1").option("-n, --hits <number>", "\u6BCF\u9801\u986F\u793A\u6578\u91CF (default: 60)", "60").option("-j, --json", "\u8F38\u51FA JSON").action(async (query, options) => {
      try {
        ...
        if (options.json) {
          ...
          results.forEach((item, idx) => {
            ...
            const price2 = item.sellingPrice && `HK$${item.sellingPrice}` || item.price && `HK$${item.price}` || item.priceList && item.priceList[0] && item.priceList[0].formattedValue || null;
...
${idx + 1}. ${title}`);
    ...
    module2.exports = searchCmd;
  }
});

// src/price.js
var require_price = __commonJS({
  "src/price.js"(exports2, module2) {
    var { Command: Command2 } = require_commander();
    var https = require("https");
    var { URL: NodeURL } = require("url");
    ...
    var program2 = new Command2("price").description("\u50F9\u683C\u76F8\u95DC\u67E5\u8A62");
    program2.command("get <code>").description("\u67E5\u8A62\u5546\u54C1\u6B77\u53F2\u50F9\u683C").option("-j, --json", "\u8F38\u51FA JSON").action(async (code, options) => {
      try {
...
program.name("hktv").version("1.0.0").description("HKTV \u8CA8\u7269\u641C\u7D22\u5DE5\u5177");
